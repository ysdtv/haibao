    ...
    'History': {
        ...
        'Init':function(){
            ...
            if(jsondata.length > 0){
                for($i=0; $i<jsondata.length; $i++){
                    html +='<dd class="even"><a class="albumtitle" href="'+jsondata[$i].link+'" target="video" title="'+jsondata[$i].name+''+jsondata[$i].part+'"><span class="fa fa-play-circle"></span>'+jsondata[$i].name+'</a></dd>';
                }
            }else{
            ...
            if($(".mac_history_set").attr('data-name')){
                ...
                MAC.History.Set($that.attr('data-name'),$that.attr('data-link'),$that.attr('data-pic'),$that.attr('data-part'));
            }
        },
        'Set':function(name,link,pic,part){
            ...
            if(jsondata != undefined){
                ...
                jsonstr = '{log:[{"name":"'+name+'","link":"'+link+'","pic":"'+pic+'","part":"'+part+'"},';
                for($i=0; $i<this.Json.length; $i++){
                    if($i<= this.Limit && this.Json[$i]){
                        jsonstr += '{"name":"'+this.Json[$i].name+'","link":"'+this.Json[$i].link+'","pic":"'+this.Json[$i].pic+'","part":"'+this.Json[$i].part+'"},';
                    }else{
                        break;
                    }
                }
